...
import "./SerieDescription.css";
import fallback from "../../images/fallback.png";

function SerieDescription() {
  const { id } = useParams();
           ...
           setError(null);
            try {
                const [movieResponse, videosResponse] = await Promise.all([
                    fetch(
                        `https://api.themoviedb.org/3/tv/${id}?api_key=1de54ccbfea3c2dcfeffd0338867c3b5`
                    ),
                    fetch(
                        `https://api.themoviedb.org/3/tv/${id}/videos?api_key=1de54ccbfea3c2dcfeffd0338867c3b5`
                    ),
                ]);
